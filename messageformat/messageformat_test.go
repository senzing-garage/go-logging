...
var testCases = []struct {
	...
	},
	{
		...
		expectedSenzing: `{"date":"date-10","time":"time-10","level":"level-10","location":"location-10","id":"id-10","status":"status-10","text":"text-10"}`,
	},
	{
		...
		expectedSenzing: `{"date":"date-11","time":"time-11","level":"level-11","location":"location-11","id":"id-11","status":"status-11","text":"text-11","duration":11}`,
	},
}
